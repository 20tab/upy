...
class ChangeList(main.ChangeList):
    ...
    def get_results(self, request):
        ...
        #label = continue to the next line
        opts.app_label + '.' + opts.get_change_permission()
        for item in self.result_list:
            if settings.UPY_TREE_EDITOR_OBJECT_PERMISSIONS:
...
class TreeEditor(admin.ModelAdmin):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.change_list_template = [
            'admin/upy/%s/%s/tree_editor.html' % (opts.app_label, opts.object_name.lower()),
            'admin/upy/%s/tree_editor.html' % opts.app_label,
            'admin/upy/tree_editor.html',
            ]
...
#        r += '</span>'
    ...
    def changelist_view(self, request, extra_context=None, *args, **kwargs):
        ...
        extra_context['UPY_ADMIN_MEDIA'] = settings.UPY_ADMIN_MEDIA
