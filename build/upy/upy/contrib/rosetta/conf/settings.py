...
MESSAGES_PER_PAGE = getattr(settings, 'ROSETTA_MESSAGES_PER_PAGE', 30)
...
STORAGE_CLASS = getattr(settings, 'ROSETTA_STORAGE_CLASS', 'upy.contrib.rosetta.storage.CacheRosettaStorage')
